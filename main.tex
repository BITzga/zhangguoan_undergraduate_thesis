...
% 第一章
\input{chapters/theory_and_tech.tex}
% 在这里添加第二章、第三章……TeX 文件的引用
\input{chapters/env.tex}
\input{chapters/procedure_change.tex}
\input{chapters/syscall_irq_exception.tex}
\input{chapters/memory.tex}
\input{chapters/process.tex}
\input{chapters/chapter_sys_test.tex}
\input{chapters/tutorial_write_and_manage.tex}
